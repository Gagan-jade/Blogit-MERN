...
export default function Register() {
    ...
    async function addUser() {
        try {
            const response = await axios.post('/api/users/addUsers', { newUserName, password });
            ...
            <div className="w-full max-w-6xl px-6 lg:px-12">
                <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between bg-gray-800 rounded-lg shadow-lg p-8 lg:p-12">
                    ...
                    <div className="w-full lg:w-1/2">
                        <h1 className="text-3xl mb-8 font-mono text-white text-center lg:text-left">Register</h1>
                        <form className="space-y-4">
                            ...
                            <div className="relative">
                                ...
                                >
                                    {showConfirmPassword ? <FaEyeSlash className="text-white size-10" /> : <FaEye className="text-white size-10" />}
                                </div>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <p className="mt-4 text-lg text-gray-300">
                                    ...
                                    <Link to="/login" className="text-blue-600 text-xl underline transition duration-150 ease-in-out hover:text-gray-300">
                                        Login
                                    </Link>
                                </p>
                            </div>
